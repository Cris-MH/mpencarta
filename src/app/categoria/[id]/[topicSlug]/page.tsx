    ...
    topics: [
      { title: "Eventos y Espacio Muestral", slug: "eventos-espacio-muestral", icon: "🎯", blurb: "Los posibles resultados de un experimento." },
      {
        ...
        detail: {
          ...
          videoId: "mE5Jjt7rOWM",
          videoTitle: "Probabilidad de un evento simple — Math2me",
          facts: [
      ...
      { title: "Teorema de Bayes", slug: "teorema-de-bayes", icon: "🧠", blurb: "Actualizar probabilidades con nueva información." },
    ],
  },
  {
    id: "discreta",
